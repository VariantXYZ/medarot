SECTION "Patch Helper Functions", ROMX[$4000], BANK[$24]

FontKana:
  INCBIN "res/gfx/fontkana.1bpp"

VWFFont:
  INCBIN "res/gfx/vwffont.1bpp"

VWFTable:
  INCLUDE "src/patch/vwftable.asm"

Font:
  INCBIN "res/gfx/font.1bpp"
FontEnd:
Font1LastRow:
  INCBIN "res/gfx/font1lastrow.2bpp"
Font2LastRow:
  INCBIN "res/gfx/font2lastrow.2bpp"
